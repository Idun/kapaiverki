        ...
        >
            {card ? (
                <div className="relative h-full w-full group">
                    ...
                    <div className={'absolute bottom-full inset-x-0 mb-2 p-2 text-sm text-center bg-zinc-800 text-white rounded-md shadow-lg transition-opacity duration-300 pointer-events-none z-30 opacity-0 group-hover:opacity-100 dark:bg-zinc-900'}>
                        {card.description}
